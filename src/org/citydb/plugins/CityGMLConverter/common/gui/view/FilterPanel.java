 ...
 */
package org.citydb.plugins.CityGMLConverter.common.gui.view;
...
public class FilterPanel extends JPanel {
	...
	public void doTranslation() {
		gmlNameLabel.setText(Util.I18N.getString("filter.label.gmlName"));
		gmlIdLabel.setText(Util.I18N.getString("filter.label.gmlId"));
		coStartLabel.setText(Util.I18N.getString("filter.label.counter.start"));
		coEndLabel.setText(Util.I18N.getString("filter.label.counter.end"));	
		((TitledBorder)row3col2.getBorder()).setTitle(Util.I18N.getString("filter.border.gmlId"));
		((TitledBorder)row4col2.getBorder()).setTitle(Util.I18N.getString("filter.border.complexFilter"));
		cityObjectFilter.setText(Util.I18N.getString("filter.border.counter"));
		gmlNameFilter.setText(Util.I18N.getString("filter.border.gmlName"));
		boundingBoxFilter.setText(Util.I18N.getString("filter.border.boundingBox"));
		featureClassFilter.setText(Util.I18N.getString("filter.border.featureClass"));
	}
	...
	public void loadSettings() {
		...
		gmlIdText.setText(org.citydb.util.Util.collection2string(filterConfig.getSimpleFilter().getGmlIdFilter().getGmlIds(), ","));
	...
	public void setSettings() {
		...
		if (gmlIdText.getText() != null && gmlIdText.getText().trim().length() > 0) {
			...
			filterConfig.getSimpleFilter().getGmlIdFilter().setGmlIds(org.citydb.util.Util.string2string(trimmed, ","));
		} else
