...
import org.citydb.modules.citygml.importer.database.content.DBImporter;
...
/**
 * Created by sn on 6/10/2015.
 */
public class OtherGeometry {
    ...
    public OtherGeometry(ConfigImpl config , SqliteImporterManager sqlliteImporterManager , int dbSrid) {
            ...
            for (GeometricPrimitiveProperty primitiveProperty : geometricComplex.getElement()) {
                if (primitiveProperty.isSetGeometricPrimitive()) {
                    ...
                    if (primitive.getGMLClass() == GMLClass.POINT)
                        pointList.add(((org.citygml4j.model.gml.geometry.primitives.Point)primitive).toList3d());
                }
            }
    ...
    public GeometryObject getMultiPoint(MultiPoint multiPoint) {
        ...
        if (multiPoint != null) {
            ...
            if (multiPoint.isSetPointMember()) {
                ...
                for (org.citygml4j.model.gml.geometry.primitives.Point point : pointArrayProperty.getPoint())
