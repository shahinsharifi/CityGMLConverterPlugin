...
public class BuildingRenderingPanel extends AbstractPreferencesComponent {
	...
	public BuildingRenderingPanel(CityKMLExportPlugin plugin) {
		super(plugin);
		initGui();
	}

	private ColladaOptions getConfigColladaOptions() {
		return plugin.getConfig().getBuildingColladaOptions();
	}

	private List<DisplayForm> getConfigDisplayForms() {
		return plugin.getConfig().getBuildingDisplayForms();
	}

	private void setConfigDisplayForms(List<DisplayForm> displayForms) {
		plugin.getConfig().setBuildingDisplayForms(displayForms);
	}

	@Override
	public String getTitle() {
		return Util.I18N.getString("pref.tree.kmlExport.buildingRendering");
	}
...
//		footprintAlphaSpinner.setMaximumSize(new Dimension(footprintAlphaSpinner.getPreferredSize().width, MAX_TEXTFIELD_HEIGHT));
	...
	public void doTranslation() {
		...
		geometryWallFillColorLabel.setText(Util.I18N.getString("pref.kmlexport.label.wallFillColor"));
		geometryWallLineColorLabel.setText(Util.I18N.getString("pref.kmlexport.label.wallLineColor"));
