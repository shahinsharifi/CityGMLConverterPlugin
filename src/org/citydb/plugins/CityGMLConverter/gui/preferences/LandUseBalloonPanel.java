...
public class LandUseBalloonPanel extends AbstractPreferencesComponent {
	...
	public LandUseBalloonPanel(CityKMLExportPlugin plugin) {
		super(plugin);
		initGui();
	}

	private Balloon getConfigBalloon() {
		return plugin.getConfig().getLandUseBalloon();
	}

	@Override
	public String getTitle() {
		return Util.I18N.getString("pref.tree.kmlExport.landUseBalloon");
	}
