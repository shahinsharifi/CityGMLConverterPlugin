...
public class GeneralPanel extends AbstractPreferencesComponent {
	...
	public GeneralPanel(CityKMLExportPlugin plugin) {
		super(plugin);
		initGui();
	}
	...
	public boolean isModified() {
		ConfigImpl kmlExporter = plugin.getConfig();
	...
	private void initGui() {
		...
		add(generalPanel, Util.setConstraints(0,0,1.0,0.0,GridBagConstraints.BOTH,BORDER_THICKNESS,0,BORDER_THICKNESS,0));
		...
		generalPanel.add(kmzCheckbox, Util.setConstraints(0,0,0.0,1.0,GridBagConstraints.BOTH,0,BORDER_THICKNESS,0,0));

		generalPanel.add(showBoundingBoxCheckbox, Util.setConstraints(0,1,0.0,1.0,GridBagConstraints.BOTH,0,BORDER_THICKNESS,0,0));

		generalPanel.add(showTileBordersCheckbox, Util.setConstraints(0,2,0.0,1.0,GridBagConstraints.BOTH,0,BORDER_THICKNESS,0,0));
		
		autoTileSideLengthText = new JFormattedTextField(threeIntFormat);
		generalPanel.add(autoTileSideLengthLabel, Util.setConstraints(0,3,0.0,1.0,GridBagConstraints.WEST,GridBagConstraints.NONE,BORDER_THICKNESS,BORDER_THICKNESS * 2,0,BORDER_THICKNESS));
		generalPanel.add(autoTileSideLengthText, Util.setConstraints(1,3,1.0,1.0,GridBagConstraints.BOTH,BORDER_THICKNESS,BORDER_THICKNESS,0,BORDER_THICKNESS));
		GridBagConstraints ml = Util.setConstraints(2,3,0.0,1.0,GridBagConstraints.NONE,BORDER_THICKNESS,BORDER_THICKNESS,0,BORDER_THICKNESS);
		ml.anchor = GridBagConstraints.WEST;
		generalPanel.add(mLabel, ml);

		generalPanel.add(oneFilePerObjectCheckbox, Util.setConstraints(0,4,0.0,1.0,GridBagConstraints.BOTH,BORDER_THICKNESS,BORDER_THICKNESS,0,0));

		visibleFromText = new JFormattedTextField(threeIntFormat);
		GridBagConstraints vfl = Util.setConstraints(0,5,0.0,1.0,GridBagConstraints.NONE,BORDER_THICKNESS,BORDER_THICKNESS * 2,0,BORDER_THICKNESS);
		vfl.anchor = GridBagConstraints.EAST;
		generalPanel.add(visibleFromLabel, vfl);
		generalPanel.add(visibleFromText, Util.setConstraints(1,5,1.0,1.0,GridBagConstraints.BOTH,BORDER_THICKNESS,BORDER_THICKNESS,0,BORDER_THICKNESS));
		GridBagConstraints pl = Util.setConstraints(2,5,0.0,1.0,GridBagConstraints.NONE,BORDER_THICKNESS,BORDER_THICKNESS,0,BORDER_THICKNESS);
		...
		GridBagConstraints wrml = Util.setConstraints(0,6,0.0,1.0,GridBagConstraints.NONE,BORDER_THICKNESS,BORDER_THICKNESS * 2,0,BORDER_THICKNESS);
		wrml.anchor = GridBagConstraints.EAST;
		generalPanel.add(viewRefreshModeLabel, wrml);
		generalPanel.add(viewRefreshModeComboBox, Util.setConstraints(1,6,1.0,1.0,GridBagConstraints.BOTH,BORDER_THICKNESS,BORDER_THICKNESS,0,BORDER_THICKNESS));

		viewRefreshTimeText = new JFormattedTextField(threeIntFormat);
		GridBagConstraints vrtl = Util.setConstraints(0,7,0.0,1.0,GridBagConstraints.NONE,BORDER_THICKNESS,BORDER_THICKNESS * 2,0,BORDER_THICKNESS);
		vrtl.anchor = GridBagConstraints.EAST;
		generalPanel.add(viewRefreshTimeLabel, vrtl);
		generalPanel.add(viewRefreshTimeText, Util.setConstraints(1,7,1.0,1.0,GridBagConstraints.BOTH,BORDER_THICKNESS,BORDER_THICKNESS,0,BORDER_THICKNESS));
		GridBagConstraints sl = Util.setConstraints(2,7,0.0,1.0,GridBagConstraints.NONE,BORDER_THICKNESS,BORDER_THICKNESS,0,BORDER_THICKNESS);
		sl.anchor = GridBagConstraints.WEST;
		generalPanel.add(sLabel, sl);

		generalPanel.add(writeJSONCheckbox, Util.setConstraints(0,8,0.0,1.0,GridBagConstraints.BOTH,BORDER_THICKNESS,BORDER_THICKNESS,0,0));
		generalPanel.add(writeJSONPCheckbox, Util.setConstraints(0,9,0.0,1.0,GridBagConstraints.EAST,GridBagConstraints.NONE,0,0,0,1));
		generalPanel.add(callbackNameJSONPLabel, Util.setConstraints(0,10,0.0,1.0,GridBagConstraints.EAST,GridBagConstraints.NONE,BORDER_THICKNESS,BORDER_THICKNESS,0,BORDER_THICKNESS));
		generalPanel.add(callbackNameJSONPText, Util.setConstraints(1,10,1.0,0.0,GridBagConstraints.HORIZONTAL,BORDER_THICKNESS,BORDER_THICKNESS,0,BORDER_THICKNESS));
	...
	public void doTranslation() {
		kmzCheckbox.setText(Util.I18N.getString("pref.kmlexport.label.exportAsKmz"));
		showBoundingBoxCheckbox.setText(Util.I18N.getString("pref.kmlexport.label.showBoundingBox"));
		showTileBordersCheckbox.setText(Util.I18N.getString("pref.kmlexport.label.showTileBorders"));
		autoTileSideLengthLabel.setText(Util.I18N.getString("pref.kmlexport.label.autoTileSideLength"));
		oneFilePerObjectCheckbox.setText(Util.I18N.getString("kmlExport.label.oneFilePerObject"));
		visibleFromLabel.setText(Util.I18N.getString("kmlExport.label.visibleFrom"));
		pixelsLabel.setText(Util.I18N.getString("kmlExport.label.pixels"));
		viewRefreshModeLabel.setText(Util.I18N.getString("kmlExport.label.viewRefreshMode"));
		viewRefreshTimeLabel.setText(Util.I18N.getString("kmlExport.label.viewRefreshTime"));
		writeJSONCheckbox.setText(Util.I18N.getString("pref.kmlexport.label.writeJSONFile"));
		writeJSONPCheckbox.setText(Util.I18N.getString("pref.kmlexport.label.writeJSONPFile"));
		callbackNameJSONPLabel.setText(Util.I18N.getString("pref.kmlexport.label.callbackNameJSONP"));
	}
	...
	public String getTitle() {
		return Util.I18N.getString("pref.tree.kmlExport.general");
	}
