...
public class TransportationBalloonPanel extends AbstractPreferencesComponent {
	...
	public TransportationBalloonPanel(CityKMLExportPlugin plugin) {
		super(plugin);
		initGui();
	}

	private Balloon getConfigBalloon() {
		return plugin.getConfig().getTransportationBalloon();
	}

	@Override
	public String getTitle() {
		return Util.I18N.getString("pref.tree.kmlExport.transportationBalloon");
	}
