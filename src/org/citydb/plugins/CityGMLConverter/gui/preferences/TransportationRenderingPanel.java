...
public class TransportationRenderingPanel extends AbstractPreferencesComponent {

	protected static final int BORDER_THICKNESS = 5;
	protected static final int MAX_TEXTFIELD_HEIGHT = 20;

	private ArrayList<DisplayForm> UtilDfs = new ArrayList<DisplayForm>();
...
*/
	...
	public TransportationRenderingPanel(CityKMLExportPlugin plugin) {
		super(plugin);
		initGui();
	}

	private ColladaOptions getConfigColladaOptions() {
		return plugin.getConfig().getTransportationColladaOptions();
	}

	private List<DisplayForm> getConfigDisplayForms() {
		return plugin.getConfig().getTransportationDisplayForms();
	}

	private void setConfigDisplayForms(List<DisplayForm> displayForms) {
		plugin.getConfig().setTransportationDisplayForms(displayForms);
	}

	@Override
	public String getTitle() {
		return Util.I18N.getString("pref.tree.kmlExport.transportationRendering");
	}

	@Override
	public boolean isModified() {
		setUtilDisplayFormValues();
		...
		for (int form = DisplayForm.FOOTPRINT; form <= DisplayForm.COLLADA; form++) {
			...
			DisplayForm UtilDf = new DisplayForm(form, -1, -1);
			int indexOfUtilDf = UtilDfs.indexOf(UtilDf); 
			if (indexOfUtilDf != -1) {
				UtilDf = UtilDfs.get(indexOfUtilDf);
			}

			if (areDisplayFormsContentsDifferent(UtilDf, configDf)) return true;
		}
...
*/
		...
		footprintFillColorButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Color fillColor = chooseColor(Util.I18N.getString("pref.kmlexport.label.chooseFillColor"),
		...
		footprintLineColorButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Color lineColor = chooseColor(Util.I18N.getString("pref.kmlexport.label.chooseLineColor"),
		...
		footprintHLFillColorButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Color hlFillColor = chooseColor(Util.I18N.getString("pref.kmlexport.label.chooseHighlightedFillColor"),
		...
		footprintHLLineColorButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Color hlLineColor = chooseColor(Util.I18N.getString("pref.kmlexport.label.chooseHighlightedLineColor"),
		...
		geometryWallFillColorButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Color wallFillColor = chooseColor(Util.I18N.getString("pref.kmlexport.label.chooseWallFillColor"),
		...
		geometryWallLineColorButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Color wallLineColor = chooseColor(Util.I18N.getString("pref.kmlexport.label.chooseWallLineColor"),
...
/*
		geometryRoofFillColorButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Color roofFillColor = chooseColor(Util.I18N.getString("pref.kmlexport.label.chooseRoofFillColor"),
		...
		geometryRoofLineColorButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Color roofLineColor = chooseColor(Util.I18N.getString("pref.kmlexport.label.chooseRoofLineColor"),
...
*/
	...
	public void doTranslation() {
		...
		((TitledBorder)footprintPanel.getBorder()).setTitle(Util.I18N.getString("pref.kmlexport.border.footprint"));	
		((TitledBorder)geometryPanel.getBorder()).setTitle(Util.I18N.getString("pref.kmlexport.border.geometry"));	
		((TitledBorder)colladaPanel.getBorder()).setTitle(Util.I18N.getString("pref.kmlexport.border.collada"));	

		footprintAlphaLabel.setText(Util.I18N.getString("pref.kmlexport.label.alpha"));
		footprintFillColorLabel.setText(Util.I18N.getString("pref.kmlexport.label.fillColor"));
		footprintLineColorLabel.setText(Util.I18N.getString("pref.kmlexport.label.lineColor"));
		footprintHighlightingCheckbox.setText(Util.I18N.getString("pref.kmlexport.label.highlighting"));
		footprintHLFillColorLabel.setText(Util.I18N.getString("pref.kmlexport.label.highlightedFillColor"));
		footprintHLLineColorLabel.setText(Util.I18N.getString("pref.kmlexport.label.highlightedLineColor"));

		geometryAlphaLabel.setText(Util.I18N.getString("pref.kmlexport.label.alpha"));
		geometryWallFillColorLabel.setText(Util.I18N.getString("pref.kmlexport.label.fillColor"));
		geometryWallLineColorLabel.setText(Util.I18N.getString("pref.kmlexport.label.lineColor"));
/*
		geometryRoofFillColorLabel.setText(Util.I18N.getString("pref.kmlexport.label.roofFillColor"));
		geometryRoofLineColorLabel.setText(Util.I18N.getString("pref.kmlexport.label.roofLineColor"));
*/
		geometryHighlightingCheckbox.setText(Util.I18N.getString("pref.kmlexport.label.highlighting"));
		geometryHLSurfaceDistanceLabel.setText(Util.I18N.getString("pref.kmlexport.label.highlightingDistance"));
		geometryHLFillColorLabel.setText(Util.I18N.getString("pref.kmlexport.label.highlightedFillColor"));
		geometryHLLineColorLabel.setText(Util.I18N.getString("pref.kmlexport.label.highlightedLineColor"));

		ignoreSurfaceOrientationCheckbox.setText(Util.I18N.getString("pref.kmlexport.label.ignoreSurfaceOrientation"));
		textureAtlasCheckbox.setText(Util.I18N.getString("pref.kmlexport.label.generateTextureAtlases"));
		textureAtlasPotsCheckbox.setText(Util.I18N.getString("pref.kmlexport.label.textureAtlasPots"));
		scaleTexImagesCheckbox.setText(Util.I18N.getString("pref.kmlexport.label.scaleTexImages"));
		groupObjectsRButton.setText(Util.I18N.getString("pref.kmlexport.label.groupObjects"));
		colladaHighlightingRButton.setText(Util.I18N.getString("pref.kmlexport.label.highlighting"));
		colladaHLSurfaceDistanceLabel.setText(Util.I18N.getString("pref.kmlexport.label.highlightingDistance"));
		colladaHLFillColorLabel.setText(Util.I18N.getString("pref.kmlexport.label.highlightedFillColor"));
		colladaHLLineColorLabel.setText(Util.I18N.getString("pref.kmlexport.label.highlightedLineColor"));
	}
	...
	public void loadSettings() {
		...
		for (int form = DisplayForm.FOOTPRINT; form <= DisplayForm.COLLADA; form++) {
			...
			DisplayForm UtilDf = configDf.clone();
			UtilDfs.add(UtilDf);
		}
		...
		for (DisplayForm displayForm : UtilDfs) {
...
*/
	...
	public void setSettings() {
		...
		if (configDfs.isEmpty()) {
			setConfigDisplayForms(UtilDfs);
		}
		else {
			for (DisplayForm UtilDf : UtilDfs) {
				int indexOfConfigDf = configDfs.indexOf(UtilDf); 
				if (indexOfConfigDf != -1) {
					DisplayForm configDf = configDfs.get(indexOfConfigDf);
					// clone cannot be used here because of isActive() and visibleFrom()
					copyColorAndHighlightingValues(UtilDf, configDf);
				}
			}
		}
...
*/
	...
	// equals cannot be used, for Util reasons it only compares the form value (FOOTPRINT, EXTRUDED...)
