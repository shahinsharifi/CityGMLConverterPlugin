...
public class CityFurnitureBalloonPanel extends AbstractPreferencesComponent {
	...
	public CityFurnitureBalloonPanel(CityKMLExportPlugin plugin) {
		super(plugin);
		initGui();
	}

	private Balloon getConfigBalloon() {
		return plugin.getConfig().getCityFurnitureBalloon();
	}

	@Override
	public String getTitle() {
		return Util.I18N.getString("pref.tree.kmlExport.cityFurnitureBalloon");
	}
