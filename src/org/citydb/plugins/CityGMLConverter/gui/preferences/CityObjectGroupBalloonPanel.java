...
public class CityObjectGroupBalloonPanel extends AbstractPreferencesComponent {
	...
	public CityObjectGroupBalloonPanel(CityKMLExportPlugin plugin) {
		super(plugin);
		initGui();
	}

	private Balloon getConfigBalloon() {
		return plugin.getConfig().getCityObjectGroupBalloon();
	}

	@Override
	public String getTitle() {
		return Util.I18N.getString("pref.tree.kmlExport.cityObjectGroupBalloon");
	}
