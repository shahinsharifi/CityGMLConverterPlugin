...
public class CityObjectGroupRenderingPanel extends AbstractPreferencesComponent {
	...
	public CityObjectGroupRenderingPanel(CityKMLExportPlugin plugin) {
		super(plugin);
		initGui();
	}

	private List<DisplayForm> getConfigDisplayForms() {
		return plugin.getConfig().getCityObjectGroupDisplayForms();
	}

	private void setConfigDisplayForms(List<DisplayForm> displayForms) {
		plugin.getConfig().setCityObjectGroupDisplayForms(displayForms);
	}

	@Override
	public String getTitle() {
		return Util.I18N.getString("pref.tree.kmlExport.cityObjectGroupRendering");
	}
	...
	public boolean isModified() {
		...
		DisplayForm UtilDf = new DisplayForm(DisplayForm.FOOTPRINT, -1, -1);
		int indexOfUtilDf = UtilDfs.indexOf(UtilDf); 
		if (indexOfUtilDf != -1) {
			UtilDf = UtilDfs.get(indexOfUtilDf);
		}

		return areDisplayFormsContentsDifferent(UtilDf, configDf);
	}
	...
	private void initGui() {
		...
		add(footprintPanel, Util.setConstraints(0,1,2,2,1.0,0.0,GridBagConstraints.BOTH,BORDER_THICKNESS,0,BORDER_THICKNESS,0));
...
//		footprintAlphaSpinner.setMaximumSize(new Dimension(footprintAlphaSpinner.getPreferredSize().width, MAX_TEXTFIELD_HEIGHT));
        ...
        GridBagConstraints fal = Util.setConstraints(0,0,0.25,1.0,GridBagConstraints.NONE,0,BORDER_THICKNESS,BORDER_THICKNESS,BORDER_THICKNESS);
		fal.anchor = GridBagConstraints.EAST;
		footprintPanel.add(footprintAlphaLabel, fal);
		footprintPanel.add(footprintAlphaSpinner, Util.setConstraints(1,0,0.25,1.0,GridBagConstraints.HORIZONTAL,0,0,BORDER_THICKNESS,0));

		GridBagConstraints ffcl = Util.setConstraints(0,1,0.25,1.0,GridBagConstraints.NONE,BORDER_THICKNESS,BORDER_THICKNESS,2*BORDER_THICKNESS,BORDER_THICKNESS);
		...
		footprintPanel.add(footprintFillColorButton, Util.setConstraints(1,1,0.25,1.0,GridBagConstraints.HORIZONTAL,BORDER_THICKNESS,0,2*BORDER_THICKNESS,0));
		
		GridBagConstraints flcl = Util.setConstraints(2,1,0.25,1.0,GridBagConstraints.NONE,BORDER_THICKNESS,BORDER_THICKNESS,2*BORDER_THICKNESS,BORDER_THICKNESS);
		...
		footprintPanel.add(footprintLineColorButton, Util.setConstraints(3,1,0.25,1.0,GridBagConstraints.HORIZONTAL,BORDER_THICKNESS,0,2*BORDER_THICKNESS,BORDER_THICKNESS));

		GridBagConstraints fhlcb = Util.setConstraints(0,2,0.5,1.0,GridBagConstraints.NONE,0,BORDER_THICKNESS,2*BORDER_THICKNESS,0);
		...
		GridBagConstraints fhlfcl = Util.setConstraints(0,3,0.25,1.0,GridBagConstraints.NONE,0,BORDER_THICKNESS,2*BORDER_THICKNESS,BORDER_THICKNESS);
		...
		footprintPanel.add(footprintHLFillColorButton, Util.setConstraints(1,3,0.25,1.0,GridBagConstraints.HORIZONTAL,0,0,2*BORDER_THICKNESS,0));

		GridBagConstraints fhllcl = Util.setConstraints(2,3,0.25,1.0,GridBagConstraints.NONE,0,BORDER_THICKNESS,2*BORDER_THICKNESS,BORDER_THICKNESS);
		...
		footprintPanel.add(footprintHLLineColorButton, Util.setConstraints(3,3,0.25,1.0,GridBagConstraints.HORIZONTAL,0,0,2*BORDER_THICKNESS,BORDER_THICKNESS));
		...
		add(footprintPanel, Util.setConstraints(0,1,2,1,1.0,0.0,GridBagConstraints.BOTH,BORDER_THICKNESS,0,BORDER_THICKNESS,0));
	}
