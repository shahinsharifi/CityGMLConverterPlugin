...
public class ReliefBalloonPanel extends AbstractPreferencesComponent {
	...
	public ReliefBalloonPanel(CityKMLExportPlugin plugin) {
		super(plugin);
		initGui();
	}

	private Balloon getConfigBalloon() {
		return plugin.getConfig().getReliefBalloon();
	}

	@Override
	public String getTitle() {
		return Util.I18N.getString("pref.tree.kmlExport.reliefBalloon");
	}
