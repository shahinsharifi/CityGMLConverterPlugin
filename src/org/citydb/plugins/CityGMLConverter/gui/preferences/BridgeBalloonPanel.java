...
public class BridgeBalloonPanel extends AbstractPreferencesComponent {
	...
	public BridgeBalloonPanel(CityKMLExportPlugin plugin) {
		super(plugin);
		initGui();
	}

	private Balloon getConfigBalloon() {
		return plugin.getConfig().getBridgeBalloon();
	}

	@Override
	public String getTitle() {
		return Util.I18N.getString("pref.tree.kmlExport.bridgeBalloon");
	}
