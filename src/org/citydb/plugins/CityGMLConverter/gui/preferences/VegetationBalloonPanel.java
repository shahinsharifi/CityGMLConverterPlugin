...
public class VegetationBalloonPanel extends AbstractPreferencesComponent {
	...
	public VegetationBalloonPanel(CityKMLExportPlugin plugin) {
		super(plugin);
		initGui();
	}

	private Balloon getConfigBalloon() {
		return plugin.getConfig().getVegetationBalloon();
	}

	@Override
	public String getTitle() {
		return Util.I18N.getString("pref.tree.kmlExport.vegetationBalloon");
	}
