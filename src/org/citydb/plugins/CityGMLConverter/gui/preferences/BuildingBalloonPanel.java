...
public class BuildingBalloonPanel extends AbstractPreferencesComponent {
	...
	public BuildingBalloonPanel(CityKMLExportPlugin plugin) {
		super(plugin);
		initGui();
	}

	private Balloon getConfigBalloon() {
		return plugin.getConfig().getBuildingBalloon();
	}

	@Override
	public String getTitle() {
		return Util.I18N.getString("pref.tree.kmlExport.buildingBalloon");
	}
