 ...
 */
package org.citydb.plugins.CityGMLConverter.gui.factory.popup;
...
public class StandardEditingPopupMenu extends AbstractStandardPopupMenu implements EventHandler {
	...
	public void doTranslation() {
		cut.setText(Util.I18N.getString("common.popup.textfield.cut"));		
		copy.setText(Util.I18N.getString("common.popup.textfield.copy"));		
		paste.setText(Util.I18N.getString("common.popup.textfield.paste"));		
		selectAll.setText(Util.I18N.getString("common.popup.textfield.selectAll"));		
	}
