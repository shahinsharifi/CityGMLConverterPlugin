...
public class StandardTreePopupMenu extends AbstractStandardPopupMenu implements EventHandler {
	...
	public void doTranslation() {
		expand.setText(Util.I18N.getString("pref.popup.expand"));		
		expandAll.setText(Util.I18N.getString("pref.popup.expandAll"));		
		collapse.setText(Util.I18N.getString("pref.popup.collapse"));		
		collapseAll.setText(Util.I18N.getString("pref.popup.collapseAll"));		
	}
