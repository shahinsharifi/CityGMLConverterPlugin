 ...
 */
package org.citydb.plugins.CityGMLConverter.gui.components.bbox;
...
public class BoundingBoxPanelImpl extends BoundingBoxPanel implements EventHandler, BoundingBoxListener {
	...
	private void doTranslation() {
		map.setToolTipText(Util.I18N.getString("common.tooltip.boundingBox.map"));
		copy.setToolTipText(Util.I18N.getString("common.tooltip.boundingBox.copy"));
		paste.setToolTipText(Util.I18N.getString("common.tooltip.boundingBox.paste"));
		srsLabel.setText(Util.I18N.getString("common.label.boundingBox.crs"));
